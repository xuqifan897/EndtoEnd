...
extern float fdividef(float x, float y);
extern float __fadd_rn(float x, float y);
extern float __fsub_rn(float x, float y);
extern float __fmul_rn(float x, float y);
extern float __fdiv_rn(float x, float y);
extern float __frcp_rn(float x);
