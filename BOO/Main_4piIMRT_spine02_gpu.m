...
% profile on
[xFista,costsFista,activeBeams,activeNorms,topN] = BOO_IMRT_L2OneHalf_gpu_QL(A,ATrans,D,Weights,params);
% profile report
...
tic
[xPolish,costsDF_polish,costs_polish] = polish_BOO_IMRT_gpu_QL(finalBeams,A,D,Weights,paramsPolish);
timePolish = toc;
