function planC = save_planC_QL(planC,saveflag,optFileName)
% Save the current CERR in workspace to file 'bz2FileName' by:
% global planC; save_planC_QL(planC,'passed',bz2FileName);
