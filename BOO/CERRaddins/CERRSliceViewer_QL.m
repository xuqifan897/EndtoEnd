function CERRSliceViewer_QL(FilePath)
% See CERRfunctions.m for how you should use this function
%
...
if ~isempty(findstr(FilePath,'.bz2'))
    outstr = gnuCERRCompression(FilePath, 'uncompress');
    FilePath = FilePath(1:end-3);
end

CERRFile = FilePath;

planC = load(FilePath,'planC');
