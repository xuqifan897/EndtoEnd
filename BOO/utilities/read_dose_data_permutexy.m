%% MODES
function dose_data = read_dose_data_permutexy( h5file, verbose, mode, thresh)
%{
...
switch ftmagic
    case 43
        result = read_sparse_format(h5file, metainfo, vhash, mode, verbose, thresh);
    otherwise
...
function result = read_sparse_format(h5file, metainfo, vhash, mode, verbose, thresh)
global MODE_SPARSEMAT MODE_SPARSEDATA MODE_METADATA MODE_ALL;
result = struct;
...
dicomsize = result.calc_metadata.full_dicom_size;
