...
wp::PhysicsList::PhysicsList() : G4VModularPhysicsList()
{
...
void wp::PhysicsList::ConstructParticle()
{
...
void wp::PhysicsList::ConstructProcess()
{
    AddTransportation();
...
void wp::PhysicsList::AddStepMax()
{
    // Step limitation seen as a process
    StepMax* stepMaxProcess = new wp::StepMax();
...
void wp::PhysicsList::AddPhysicsList(const G4String& name)
{
    if (verboseLevel>-1) {
        G4cout << "wp::PhysicsList::AddPhysicsList: <" << name << ">" << G4endl;
    }
