...
sa::PhysicsList::PhysicsList() : G4VModularPhysicsList()
{
...
void sa::PhysicsList::ConstructParticle()
{
...
void sa::PhysicsList::ConstructProcess()
{
    AddTransportation();
...
void sa::PhysicsList::AddStepMax()
{
    // Step limitation seen as a process
    StepMax* stepMaxProcess = new sa::StepMax();
...
void sa::PhysicsList::AddPhysicsList(const G4String& name)
{
    if (verboseLevel>-1) {
        G4cout << "sa::PhysicsList::AddPhysicsList: <" << name << ">" << G4endl;
    }
