#ifndef AlternativeDetectorConstruction_h
#define AlternativeDetectorConstruction_ 1
...
namespace bs
{
    class AlternativeDetectorConstruction : public G4VUserDetectorConstruction
    {
        public:
        AlternativeDetectorConstruction(float offset, float thickness)
            : offset(offset), thickness(thickness) {}
        ~AlternativeDetectorConstruction() = default;
