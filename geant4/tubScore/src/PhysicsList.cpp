...
ts::PhysicsList::PhysicsList() : G4VModularPhysicsList()
{
...
void ts::PhysicsList::ConstructParticle()
{
...
void ts::PhysicsList::ConstructProcess()
{
    AddTransportation();
...
void ts::PhysicsList::AddStepMax()
{
    // Step limitation seen as a process
    StepMax* stepMaxProcess = new ts::StepMax();
...
void ts::PhysicsList::AddPhysicsList(const G4String& name)
{
    if (verboseLevel>-1) {
        G4cout << "ts::PhysicsList::AddPhysicsList: <" << name << ">" << G4endl;
    }
